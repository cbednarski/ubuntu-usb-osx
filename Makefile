...
burn-1404-desktop: ubuntu-14.04.2-desktop-amd64.iso
...
burn-1404-server: ubuntu-14.04.2-server-amd64.iso
	diskutil unmountDisk /dev/disk$(DISK)
...
burn-1504-desktop: ubuntu-15.04-desktop-amd64.iso
	diskutil unmountDisk /dev/disk$(DISK)
...
burn-1504-server: ubuntu-15.04-server-amd64.iso
	diskutil unmountDisk /dev/disk$(DISK)
